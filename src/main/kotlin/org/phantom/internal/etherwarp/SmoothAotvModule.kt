package org.phantom.internal.etherwarp
...
import org.phantom.api.util.getSkyblockExtraAttributes
...
object SmoothAotvModule : Module("Smooth AOTV") {
  ...
  private val zpew = CheckboxSetting(
    "ZPEW",
    "Zero Ping Etherwarp â€” instantly apply predicted etherwarp position client-side and send a position packet, skipping camera animation.",
    false
  )
